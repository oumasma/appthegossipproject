...
10.times do
	User.create(first_name:Faker::Name.first_name, last_name:Faker::Name.last_name, description:Faker::Movies::Ghostbusters.quote, email:Faker::Internet.email, age:rand(10..100), city_id:rand(City.first.id..City.last.id))
end
